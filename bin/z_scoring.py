...
def calculate_integer_scores(df):
    ...
    scores = [top20 * [5], top20 * [4], top20 * [3], top20 * [2],
              last_score * [1]]
    ...
    score.loc[(score['Z-score'] > 5) & (
            score['Z-score'] < 10), 'zscore_score'] = 5
    score.loc[(score['Z-score'] > 3) & (
            score['Z-score'] < 5), 'zscore_score'] = 3
    score.loc[(score['Z-score'] > 2) & (
            score['Z-score'] < 3), 'zscore_score'] = 2
    score.loc[(score['Z-score'] > 1) & (
            score['Z-score'] < 2), 'zscore_score'] = 1
